...
class Controller:
    def __init__(
        ...
        self.projector = projector or Projector(
            None, "...", "...", None, None, debug_mode=debug_mode
        )
    ...
    def start(self):
        ...
        while self.running:
            ...
            if self.last_result and len(self.last_result) == 5:
                ...
                self.show_full_projection(
                    image, safe_python_code, safe_code_output, boxes, error_box
                )
    ...
    def show_full_projection(
        self, image, python_code, code_output, boxes, error_box=None
    ):
    ...
    def process_frame(self):
        ...
        try:
            ...
            safe_code_output = (
                "..."
                if (code_output is None and exec_error is None)
                else (exec_error if exec_error else code_output)
            )
