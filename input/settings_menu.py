...
class SettingsMenu:
    ...
    def create_device_settings_tab(self):
        ...
        # Add gesture control checkbox
        self.gesture_var = tk.BooleanVar(value=settings["HAND_GESTURES"])
        ttk.Checkbutton(
            main_frame, text="Enable Hand Gestures", variable=self.gesture_var
        ).grid(row=row, column=0, sticky="w", pady=2)
        row += 1
            ...
            settings.update(
                {
                    ...
                    "PROJECTION_RESOLUTION": [
                        int(self.proj_res_width.get()),
                        int(self.proj_res_height.get()),
                    ],
                    ...
                    "HAND_GESTURES": self.gesture_var.get(),
